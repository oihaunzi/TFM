...
INPUT_DIR = "/RAID5-22TB/ohiane.unzilla/HOLMESWATSON/H123-Website-Fingerprinting/HOLMES/20accesos_csv_label_sin_outliers"

OUTPUT_CSV = os.path.join(
    BASE_DIR,
    "resultados",
    "estabilidad_intraclase_watson_sin_outliers.csv"
)
...
if df.empty:
    raise ValueError("No se ha cargado ningún acceso H123-compact válido sin outliers.")
...
if res.empty:
    raise ValueError("No se ha podido calcular ninguna distancia intra-clase sin outliers.")
...
print("\nTOP 20 MÁS ESTABLES SIN OUTLIERS SEGÚN WATSON\n")
print(
    res[
        [
            "url",
...
print("\nTOP 20 MÁS INESTABLES SIN OUTLIERS SEGÚN WATSON\n")
print(
    res[
        [
            "url",
