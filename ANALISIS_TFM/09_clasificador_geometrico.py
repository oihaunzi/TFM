...
OUTPUT_PREDICCIONES = os.path.join(
    BASE_DIR,
    "resultados",
    "accuracy_geometrico_predicciones.csv"
)

OUTPUT_RESUMEN = os.path.join(
    BASE_DIR,
    "resultados",
    "accuracy_geometrico_resumen.txt"
)
...
with open(OUTPUT_RESUMEN, "w") as f:
    f.write("CLASIFICADOR GEOMÉTRICO 1-NN CON OUTLIERS\n")
    f.write("=========================================\n\n")
    ...
    f.write(f"Accuracy geométrico: {accuracy:.4f}\n")
    f.write(f"Accuracy geométrico (%): {accuracy * 100:.2f}%\n\n")
...
print("\nCLASIFICADOR GEOMÉTRICO 1-NN CON OUTLIERS")
print("=========================================")
